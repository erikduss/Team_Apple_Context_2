...
public class CrowsHelpQuest : IQuest
{
    /*
    ...
    private string _questname = "crowsQuest";
    ...
    public CrowsHelpQuest()
    {
        ...
        AddQuestStep("Murder of crows", "There seems to be an abundance of crows in this area, you decide to give a helping hand. They seem to want something from the orange tree.", null);
        AddQuestStep("...", "You take the wood.", new QuestStepReward(100, -50, -20, 0, -25, 0));
        AddQuestStep("Murder of crows", "The crows caw at you, happily feeding off of the seeds.", new QuestStepReward(-50, 0, 0, 0, 0, 40));
    }
