...
public class HermitQuest : IQuest
{
    /*
    ...
    private string _questname = "hermitQuest";
    ...
    public HermitQuest()
    {
        ...
        AddQuestStep("Hermit", "HEY, YOU! I LIKE CATS, I MIS MY CAT FLUFFLES! GO FIND TIGERS AND TRY TO CATCH ONE!", null);
        AddQuestStep("...", "You take the wood.", new QuestStepReward(100, -50, -20, 0, -25, 0));
        AddQuestStep("Hermit", "THANK YOU! I LOVE MY NEW CAT!", new QuestStepReward(-50, 0, 0, 0, 0, 40));
    }
