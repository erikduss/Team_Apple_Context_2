...
public class DeerResqueQuest : IQuest
{
    /*
    ...
    private string _questname = "deerQuest";
    ...
    public DeerResqueQuest()
    {
        ...
        AddQuestStep("Deer", "You hear a distress call coming from a distant. There seems to be some wildlife stuck on a island. Water is surging around the island. How could I help them?", null);
        AddQuestStep("...", "You take the wood.", new QuestStepReward(100, -50, -20, 0, -25, 0));
        AddQuestStep("Deer", "The deer somehow seems grateful for your assistance.", new QuestStepReward(-50, 0, 0, 0, 0, 40));
    }
